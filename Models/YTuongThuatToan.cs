...
@"Thuật toán Heap Sort sắp xếp dựa trên ý tưởng là không 
gian cần sắp xếp đã được sắp xếp một phần và ta chỉ cần 
thêm giá trị mới vào không gian này sao cho không gian 
mới được sắp xếp.";
...
sắp xếp không gian con này bằng thuật toán Quick Sort.
...
@"Thuật toán Interchange Sort sẽ duyệt qua tất cả các cặp
giá trị trong mảng và hoán vị hai giá trị trong một cặp 
nếu cặp giá trị đó là nghịch thế.";
...
@"- Thuật toán Selection Sort sắp xếp bằng cách đưa các 
phần tử vào đúng vị trí của nó.";
...
@"- Thuật toán Bubble Sort sắp xếp bằng cách liên tục so 
sánh và hoán vị các cặp phần tử kề nhau. 
- Phần tử lớn nhất/nhỏ nhất sẽ 'nổi' lên vị trí cuối sau 
mỗi lượt duyệt.";
...
@"Thuật toán Insertion Sort sắp xếp dựa trên ý tưởng là 
không gian cần sắp xếp đã được sắp xếp một phần và ta 
chỉ cần thêm giá trị mới vào không gian này sao cho 
không gian mới được sắp xếp.";
